  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center py-12 px-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute w-96 h-96 bg-pink-500/20 rounded-full blur-3xl top-0 right-0"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.5, 0.3]
          }}
        ...
        />
        <motion.div
          className="absolute w-96 h-96 bg-blue-500/20 rounded-full blur-3xl bottom-0 left-0"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.4, 0.6, 0.4]
          }}
      ...
      >
        ...
        <div className="bg-gradient-to-br from-slate-800/90 to-purple-900/50 p-10 rounded-3xl border-2 border-purple-500/30 shadow-2xl backdrop-blur-xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Join us and start managing tasks smarter</p>
          </div>
